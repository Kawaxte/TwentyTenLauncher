  ...
  public static void main(String[] args) {
    ...
    if (MAX_MEMORY < MIN_MEMORY) {
      ...
      try {
        ...
        LoggingManager.logError(Launcher.class, "Failed to start the process", ioe);
        ...
        LoggingManager.logError(Launcher.class, "Failed to wait for the process to terminate",
            ie);
      }
    } else {
